...
async function updatePackageFile(destPath: string, name: string, description: string, repoUrl: string): Promise<void> {
    ...
    const replacedDescriptionText = packageContents.replace(descriptionRegex, `"${description}"`);
 ...
 * @param repoUrl -
 */
export async function createTypeScriptTemplate(name: string, description: string, repoUrl: string): Promise<void> {
    const destPath = path.resolve("."),
        emptyPath = path.resolve(__dirname, "../..", "files", "empty-project", "ts"),
        sourcePath = path.resolve(__dirname, "../..", "files", "create-preset", "ts");
